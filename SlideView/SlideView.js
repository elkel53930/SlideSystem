...
var _user$project$SlideView$secToString = function (time) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('プライベートでの開発'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('17.11.20 飯田一輝'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$SlideView$totalPageNum = _elm_lang$core$List$length(_user$project$SlideView$slide);
var _user$project$SlideView$pageUpdate = F2(
	function (model, add) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				pageNum: A2(_elm_lang$core$Basics_ops['%'], model.pageNum + add, _user$project$SlideView$totalPageNum)
			});
	});
var _user$project$SlideView$pageUpdateByKey = F2(
	function (model, code) {
		var _p0 = code;
		switch (_p0) {
			case 37:
...
var _user$project$SlideView$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Tick':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$SlideView$pageUpdateByKey, model, _p1._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$SlideView$footer = function (model) {
	return A2(
...
var _user$project$SlideView$Click = function (a) {
	return {ctor: 'Click', _0: a};
};
var _user$project$SlideView$Init = function (a) {
	return {ctor: 'Init', _0: a};
};
var _user$project$SlideView$init = {
	ctor: '_Tuple2',
	_0: A5(_user$project$SlideView$Model, 0, 0, 0, 0, 0),
	_1: A2(_elm_lang$core$Task$perform, _user$project$SlideView$Init, _elm_lang$core$Time$now)
};
var _user$project$SlideView$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$SlideView$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$mouse$Mouse$clicks(_user$project$SlideView$Click),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$SlideView$Key),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$SlideView$Tick),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$SlideView$main = _elm_lang$html$Html$program(
	{init: _user$project$SlideView$init, view: _user$project$SlideView$view, update: _user$project$SlideView$update, subscriptions: _user$project$SlideView$subscriptions})();

var Elm = {};
Elm['SlideView'] = Elm['SlideView'] || {};
if (typeof _user$project$SlideView$main !== 'undefined') {
    _user$project$SlideView$main(Elm['SlideView'], 'SlideView', undefined);
}
